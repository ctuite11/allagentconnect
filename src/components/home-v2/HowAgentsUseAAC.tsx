...
const HowAgentsUseAAC = () => {
  return (
    <section
      className="w-full py-28 px-6 relative"
      style={{
        backgroundColor: "#f0f1f7",
        backgroundImage: "linear-gradient(rgba(37,55,255,0.055) 1px, transparent 1px), linear-gradient(90deg, rgba(37,55,255,0.055) 1px, transparent 1px)",
      ...
      <div className="max-w-[1200px] mx-auto flex flex-col gap-14">
        ...
        <div className="flex flex-col items-center gap-5 text-center max-w-[600px] mx-auto">
          <div className="inline-flex items-center gap-2 pl-3.5 pr-5 py-2 bg-[#2537ff0f] border border-[#2537ff26] rounded-full">
            <span className="font-['Manrope'] font-semibold text-[#2537ff] text-[14px] tracking-[0.28px]">How agents use the platform</span>
          </div>
          <h2 className="font-['Manrope'] font-bold text-[#1a1d23] text-[clamp(30px,4vw,46px)] tracking-[-1.5px] leading-[1.18]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-[0_2px_20px_rgba(41,45,50,0.07)] border border-[#e8eaf0]">
            <div className="flex flex-col justify-center bg-[#f4f5f9] px-5 py-4 overflow-hidden" style={{ minHeight: 260 }}>
              <div className="flex flex-col gap-2.5">
                {[
                  { label: "Filter by property", icon: <path d="M3 6h18M7 12h10M11 18h2" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" /> },
                  { label: "Search by type", icon: <><circle cx="11" cy="11" r="8" stroke="#6b7280" strokeWidth="2" /><path d="m21 21-4.35-4.35" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" /></> },
                  { label: "Sort by date", icon: <><rect x="3" y="4" width="18" height="18" rx="2" stroke="#6b7280" strokeWidth="2" /><path d="M3 9h18M8 2v4M16 2v4" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" /></> },
                  { label: "Group by status", icon: <><rect x="3" y="3" width="8" height="8" rx="1.5" stroke="#6b7280" strokeWidth="2" /><rect x="13" y="3" width="8" height="8" rx="1.5" stroke="#6b7280" strokeWidth="2" /><rect x="3" y="13" width="8" height="8" rx="1.5" stroke="#6b7280" strokeWidth="2" /><rect x="13" y="13" width="8" height="8" rx="1.5" stroke="#6b7280" strokeWidth="2" /></> },
                ].map((row, i) => (
                  <div key={row.label} className="flex items-center justify-between px-4 py-3 bg-white rounded-xl border border-[#e8eaf0]" style={{ opacity: i === 3 ? 0.55 : 1 }}>
                    <span className="font-['Manrope'] font-medium text-[#292d32] text-[13px]">{row.label}</span>
            ...
            <div className="flex flex-col gap-2.5 p-5">
              <h3 className="font-['Manrope'] font-bold text-[#1a1d23] text-[17px] leading-[1.3]">Discover opportunities</h3>
              <p className="font-['Manrope'] font-medium text-[#6b7280] text-[13px] leading-[1.65]">Structured, searchable listings matching private listings with buyer and renter needs.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-[0_2px_20px_rgba(41,45,50,0.07)] border border-[#e8eaf0]">
              ...
              <div className="flex flex-col gap-2 w-full">
                <div className="flex items-center justify-between px-3.5 py-2.5 bg-white rounded-full shadow-sm border border-[#e8eaf0]">
                  <div className="flex items-center gap-2.5">
                    <div className="w-6 h-6 rounded-full bg-[#e8f0fe] flex items-center justify-center shrink-0">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none"><rect x="2" y="4" width="20" height="16" rx="3" stroke="#2537ff" strokeWidth="2" /><path d="M2 8l10 6 10-6" stroke="#2537ff" strokeWidth="2" strokeLinecap="round" /></svg>
                    </div>
                    <span className="font-['Manrope'] font-semibold text-[#292d32] text-[12px]">Share via email</span>
                  </div>
                ...
                <div className="flex items-center justify-between px-3.5 py-2.5 bg-white rounded-full shadow-sm border border-[#e8eaf0]">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="font-['Manrope'] font-semibold text-[#292d32] text-[12px]">Share across social media</span>
                  </div>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="#b0b8c9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-2.5 p-5">
              <h3 className="font-['Manrope'] font-bold text-[#1a1d23] text-[17px] leading-[1.3]">Share inventory</h3>
              <p className="font-['Manrope'] font-medium text-[#6b7280] text-[13px] leading-[1.65]">Verified agents share off-market and coming-soon opportunities inside the network.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-[0_2px_20px_rgba(41,45,50,0.07)] border border-[#e8eaf0]">
            ...
            <div className="flex flex-col gap-2.5 p-5">
              <h3 className="font-['Manrope'] font-bold text-[#1a1d23] text-[17px] leading-[1.3]">Collaborate</h3>
              <p className="font-['Manrope'] font-medium text-[#6b7280] text-[13px] leading-[1.65]">Direct agent-to-agent coordination without public posts, email chains, or group noise.</p>
            </div>
          </div>
        </div>
      </div>
