...
/**
 * AAC Monogram — inline SVG from the brand master asset.
 * Two paths: blue main shape + green connect letterform.
 * Transparent background, designed for dark surfaces.
 */
const Monogram: React.FC<MonogramProps> = ({ size = 64, className = "" }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
      aria-label="AAC monogram"
    >
      {/* Main shape — brand blue */}
      <path
        ...
        fill="#0E56F5"
      />
      {/* Connect letterform — brand green */}
      <path
        transform="translate(436,572)"
        d="m0 0h207l1 1v50l-3 16-6 15-7 12-11 12-9 8-11 7-15 6-14 3-13 1h-24l-10 3-4 2-2 4-2 5v86l5 10 7 4 4 1h182l8-3 6-7h1v45l-3 15-6 16-8 15-13 16-7 7-16 11-15 7-18 6h-2v2h-182l-18-4-16-7-12-9-9-9-7-10-7-14-4-13-2-12v-248l4-16 6-11 9-10 11-7 11-4z"
        fill="#059669"
      />
    </svg>
  );
