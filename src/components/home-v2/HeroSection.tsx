      ...
      <div className="relative z-10 flex flex-col justify-center flex-1 px-6 lg:px-[100px] pt-20 pb-32 max-w-[1440px] mx-auto w-full">
        <div className="max-w-[580px] flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 mt-1 flex-wrap">
            <button className="h-auto inline-flex items-center gap-2 px-[17px] py-[9px] bg-[#50c878] rounded-[90px] border-[4px] border-[#50c87866] hover:bg-[#3dba68] transition-colors font-['Manrope'] font-bold text-white text-[15px]">
              Request access
