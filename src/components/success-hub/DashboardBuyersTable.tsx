  ...
  return (
    <div>
      ...
      <div className="overflow-hidden rounded-xl md:rounded-2xl">
        {buyers.length === 0 ? (
          <div className="py-10 text-center text-sm text-neutral-500">No buyers yet.</div>
        ) : (
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-zinc-100 bg-white">
                ...
                <th className="px-4 py-3 text-center text-xs font-medium text-neutral-500">Hot Sheets</th>
                <th className="hidden px-4 py-3 text-left text-xs font-medium text-neutral-500 sm:table-cell">
                  Email
                </th>
                <th className="w-8" />
              </tr>
            ...
            <tbody className="divide-y divide-zinc-100">
              {buyers.slice(0, 6).map((b) => {
                ...
                return (
                  ...
                  >
                    <td className="max-w-[140px] truncate px-4 py-2.5 font-medium text-neutral-900">{name}</td>
                    ...
                    <td className="px-4 py-2.5 text-center text-neutral-500">{b.hotSheetCount}</td>
                    <td className="hidden max-w-[160px] truncate px-4 py-2.5 text-neutral-500 sm:table-cell">
                      {b.email}
                    </td>
