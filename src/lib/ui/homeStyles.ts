...
export const homeStyles = {
  ...
  // ============ CARDS ============
  cardBase: "rounded-3xl border border-zinc-200 bg-white shadow-[0_10px_30px_rgba(0,0,0,0.08)]",
  cardLight: "rounded-3xl border border-zinc-200 bg-white shadow-[0_6px_18px_rgba(0,0,0,0.06)]",
  cardHover: "hover:shadow-[0_10px_26px_rgba(0,0,0,0.08)] transition",
  cardPadding: "p-6",
  cardPaddingLg: "p-7 sm:p-9",

  // ============ ICON CONTAINERS ============
  iconBox: "h-10 w-10 rounded-2xl border border-zinc-200 bg-[#F7F6F3] flex items-center justify-center",
  ...
  btnSecondarySm: "inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium text-zinc-700 hover:text-zinc-900 hover:bg-white/60 transition",

  // ============ TYPOGRAPHY ============
  // Headings
  h1: "font-display text-4xl sm:text-5xl font-semibold tracking-tight text-zinc-900",
  h2: "text-2xl sm:text-3xl font-semibold tracking-tight text-zinc-900",
  h3: "text-xl font-semibold tracking-tight text-zinc-900",
  
  // Subheadings & taglines
  tagline: "text-lg sm:text-xl font-semibold tracking-tight text-zinc-800",
  label: "text-xs text-zinc-500",
  
  // Body text
  textBody: "text-zinc-600",
  textBodySm: "text-sm text-zinc-600",
  ...
  borderLight: "border-zinc-200/70",
