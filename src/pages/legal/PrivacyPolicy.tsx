...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-background">
      <Seo title="Privacy Policy" description="Privacy policy for All Agent Connect, the private real estate agent collaboration platform." canonical="https://allagentconnect.com/privacy" />
