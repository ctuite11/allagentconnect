  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-base font-semibold text-zinc-900">Project photos</h2>
          <p className="text-sm text-zinc-500">Stored in private development media; signed URLs only.</p>
        </div>
        {canEdit ? (
