...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-slate-900 pb-12">
      ...
      {/* Below-hero content with lighter background */}
      <div className="bg-white">
        ...
        <section id="how" className="mx-auto max-w-6xl px-5 py-10">
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-7 sm:p-9 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
        ...
        <section id="access" className="mx-auto max-w-6xl px-5 py-10 pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-stretch">
            <div className="lg:col-span-3 rounded-3xl border border-slate-200 bg-slate-50 p-7 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
            ...
            <div className="lg:col-span-2 rounded-3xl border border-slate-200 bg-slate-50 p-7 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
