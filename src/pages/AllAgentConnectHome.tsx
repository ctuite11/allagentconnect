      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[1280px] mx-auto px-6 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Listing Search */}
            <div className="p-6 rounded-2xl border border-neutral-200 bg-background shadow-[0_2px_6px_rgba(0,0,0,0.06)] hover:border-neutral-300 hover:shadow-[0_6px_16px_rgba(0,0,0,0.10)] transition-all">
