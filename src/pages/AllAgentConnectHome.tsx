      ...
      <div className="min-h-screen bg-neutral-50">
        ...
        <div className="max-w-[1280px] mx-auto px-6 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Listing Search */}
            <div className="p-6 rounded-2xl border border-neutral-200 bg-white shadow-[0_2px_6px_rgba(0,0,0,0.06)] hover:border-neutral-300 hover:shadow-[0_6px_16px_rgba(0,0,0,0.10)] transition-all">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              ...
              className="group flex items-center gap-4 p-4 rounded-xl border border-neutral-200 bg-white shadow-[0_2px_6px_rgba(0,0,0,0.06)] hover:border-neutral-300 hover:shadow-[0_6px_16px_rgba(0,0,0,0.10)] transition-all text-left"
            >
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-3">
            <button
              ...
              className="group flex items-center gap-3 p-3 rounded-lg border border-neutral-200 bg-white shadow-[0_2px_6px_rgba(0,0,0,0.06)] hover:border-neutral-300 hover:shadow-[0_6px_16px_rgba(0,0,0,0.10)] transition-all text-left"
            >
