...
export const usNeighborhoodsByCityState: Record<string, string[]> = {
  // Massachusetts
  "Boston-MA": ["Aberdeen", "Allston", "Back Bay", "Bay Village", "Beacon Hill", "Brighton", "Brighton's Chestnut Hill", "Charlestown", "Chinatown", "Dorchester", "Downtown", "East Boston", "Fenway", "Hyde Park", "Jamaica Plain", "Mattapan", "Mission Hill", "North End", "Roslindale", "Roxbury", "Seaport", "South Boston", "South End", "Waterfront", "West End", "West Roxbury"],
