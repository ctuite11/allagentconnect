...
// Icons - using primary (AAC blue)
export const iconGreen = "h-6 w-6 text-primary";
export const iconGreenSmall = "h-5 w-5 text-primary";
export const iconGreenFill = "text-primary fill-primary";

// Buttons - using primary (AAC blue)
...
export const primaryButton = "bg-primary hover:bg-primary/90 text-white rounded-full px-5 py-2.5 font-medium transition-colors";
