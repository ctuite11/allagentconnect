export const RealResultsVisualizationSection = (): JSX.Element => {
  return (
    <section className="w-full bg-white flex flex-col items-center pt-28 pb-0 px-6">
      ...
      <div className="mb-6 inline-flex items-center gap-2 pl-3.5 pr-5 py-2 bg-[#2537ff0f] border border-[#2537ff26] rounded-full">
        <img src="https://c.animaapp.com/mmm3cgevnH1M3s/img/vuesax-bold-chart-1.svg" alt="" className="w-[16px] h-[16px] shrink-0" />
        <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#2537ff] text-[14px] tracking-[0.28px]">Our network values</span>
      </div>

      {/* Headline + sub */}
      <div className="flex flex-col items-center gap-4 mb-12 max-w-[820px] w-full text-center">
        <h2 className="[font-family:'Manrope',Helvetica] font-bold text-[#292d32] text-[clamp(30px,3.8vw,52px)] tracking-[-2px] leading-[1.18]">
      ...
      <div className="relative w-full max-w-[1260px] flex items-center justify-center">
        ...
        {/* Dashboard image — unchanged, centered */}
        <div className="relative z-10 w-full max-w-[900px] mx-auto">
          ...
          {/* ── BADGE LAYOUT ─────────────────────────────────────────────────── */}
          {/*
            Desktop: 4 absolute badges forming a 2×2 grid around the dashboard
              Top-left    @ (top: 10%,  left: 0%,  translateX(-52%))
              Bottom-left @ (top: 58%,  left: 0%,  translateX(-52%))
              Top-right   @ (top: 10%,  right: 0%, translateX(52%))
              Bottom-right@ (top: 58%,  right: 4%, translateX(52%))

            Tablet (<lg): badges leave absolute flow → 2×2 responsive grid
            Mobile: single column, badges sit below dashboard
          */}

          {/* TOP-LEFT — "For those clients looking for privacy" — solid white */}
          <div
          ...
          >
            ...
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[13px] leading-[1.4] whitespace-nowrap">For those clients looking for privacy</span>
          </div>

          {/* BOTTOM-LEFT — "Increased agent production / GCI" — solid white, aligned with top-left */}
          <div
            className="hidden md:flex absolute z-30 items-center gap-2.5 bg-white rounded-full px-4 py-2.5 shadow-[0_8px_20px_rgba(0,0,0,0.08)]"
          ...
          >
            ...
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[13px] leading-[1.4] whitespace-nowrap">Increased agent production / GCI</span>
          </div>

          {/* TOP-RIGHT — "Access the Unlisted" — solid white */}
          <div
            className="hidden md:flex absolute z-30 items-center gap-2.5 bg-white rounded-full px-4 py-2.5 shadow-[0_8px_20px_rgba(0,0,0,0.08)]"
          ...
          >
            ...
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[13px] leading-[1.4] whitespace-nowrap">Access the Unlisted</span>
          </div>

          {/* BOTTOM-RIGHT — "Direct seller + buyer-agent opportunities" — solid white, aligned with top-right */}
          <div
            className="hidden md:flex absolute z-30 items-center gap-2.5 bg-white rounded-full px-4 py-2.5 shadow-[0_8px_20px_rgba(0,0,0,0.08)]"
          ...
          >
            ...
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[13px] leading-[1.4] whitespace-nowrap">Direct seller + buyer-agent opportunities</span>
          </div>
        </div>
      </div>

      {/* Tablet / mobile badge grid (visible < md, hidden on desktop where absolute badges show) */}
      <div className="md:hidden w-full max-w-[900px] mx-auto mt-6 grid grid-cols-2 gap-3 px-2">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2.5 bg-white rounded-full px-4 py-2.5 shadow-[0_4px_16px_rgba(41,45,50,0.16)]">
            <img src="https://c.animaapp.com/mmm3cgevnH1M3s/img/vuesax-bold-shield-tick.svg" alt="" className="w-[16px] h-[16px] shrink-0" />
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[12px] leading-[1.4]">For those clients looking for privacy</span>
          </div>
          {/* GCI */}
          <div className="flex items-center gap-2.5 bg-white rounded-full px-4 py-2.5 shadow-[0_4px_16px_rgba(41,45,50,0.16)]">
            <img src="https://c.animaapp.com/mmm3cgevnH1M3s/img/vuesax-bold-chart-1.svg" alt="" className="w-[16px] h-[16px] shrink-0" />
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[12px] leading-[1.4]">Increased agent production / GCI</span>
          </div>
        </div>
        {/* Right column */}
        <div className="flex flex-col gap-3">
          {/* Access the Unlisted */}
          <div className="flex items-center gap-2.5 bg-white rounded-full px-4 py-2.5 shadow-[0_4px_16px_rgba(41,45,50,0.16)]">
            <img src="https://c.animaapp.com/mmm3cgevnH1M3s/img/vuesax-bold-archive-tick.svg" alt="" className="w-[16px] h-[16px] shrink-0" />
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[12px] leading-[1.4]">Access the Unlisted</span>
          </div>
          {/* Direct seller */}
          <div className="flex items-center gap-2.5 bg-white rounded-full px-4 py-2.5 shadow-[0_4px_16px_rgba(41,45,50,0.16)]">
            <img src="https://c.animaapp.com/mmm3cgevnH1M3s/img/vuesax-bold-star.svg" alt="" className="w-[16px] h-[16px] shrink-0" />
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[12px] leading-[1.4]">Direct seller + buyer-agent opportunities</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div
              ...
              style={{ aspectRatio: "350/365" }}
            >
              <img src={card.image} alt={card.label} className="absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#000000c0] via-[#00000020] to-transparent" />
              {/* Badge */}
              <div className="absolute top-3 left-3">
                <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-full shadow">
                  ...
                  <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#292d32] text-[12px] tracking-[0.2px] whitespace-nowrap">{card.label}</span>
                </div>
              </div>
              {/* Price */}
              <div className="absolute bottom-5 left-5">
                <span className="[font-family:'Manrope',Helvetica] font-semibold text-white text-[16px] tracking-[0.16px]">{card.price}</span>
              </div>
            </div>
          ))}
        </div>
