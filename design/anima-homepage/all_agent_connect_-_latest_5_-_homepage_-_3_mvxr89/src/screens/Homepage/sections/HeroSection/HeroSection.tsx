    ...
    <section className="relative w-full min-h-screen bg-[#111317] overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col justify-center flex-1 px-6 lg:px-[100px] pt-20 pb-32 max-w-[1440px] mx-auto w-full">
        <div className="max-w-[580px] flex flex-col gap-6">
          ...
          {/* Eyebrow label */}
          <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-[#ffffff0d] border border-[#ffffff1a] rounded-full w-fit">
            <span className="w-[7px] h-[7px] rounded-full bg-[#50c878] shrink-0" />
            <span className="[font-family:'Manrope',Helvetica] font-semibold text-[#ffffffcc] text-sm tracking-[0.28px]">
          ...
          {/* Headline */}
          <h1
            className="[font-family:'Manrope',Helvetica] font-extrabold text-white text-[clamp(38px,4.8vw,64px)] tracking-[-2.5px] leading-[1.07]"
          ...
          {/* Sub-headline */}
          <p className="[font-family:'Manrope',Helvetica] font-medium text-[#ffffff80] text-[17px] leading-[1.75] tracking-[0.2px]">
          ...
          <div className="flex items-center gap-4 mt-1 flex-wrap">
            <Button className="h-auto inline-flex items-center gap-3 pl-7 pr-6 py-[14px] bg-[#50c878] rounded-[90px] border-[5px] border-[#50c87866] hover:bg-[#3dba68] transition-colors">
              <span className="[font-family:'Manrope',Helvetica] font-bold text-white text-[17px] whitespace-nowrap">
                Request access
              </span>
