...
Review each section at 375px–768px widths and fix any overflow or tight spacing issues
</todo>

<todo>
Verify marquee loop is seamless at different viewport widths
Check that the trust strip doesn't show a visible jump or gap during the animation loop
</todo>
