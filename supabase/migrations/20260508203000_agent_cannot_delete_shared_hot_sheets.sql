-- Hot sheet delete ownership: buyers (and admins) may delete shared group sheets;
-- sheet owners who are agents may NOT full-delete a sheet once it has shared / accepted
-- workspace recipients (linked AAC buyers or accepted client_hotsheet_invite tokens).
