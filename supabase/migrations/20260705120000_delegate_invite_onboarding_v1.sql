-- =============================================================================
-- Delegate Invite Onboarding V1
-- Preview RPC, delegate routing role, single-owner constraint
-- =============================================================================

-- One accepted owner per delegate (V1: no multi-account switching)
...
-- ---------------------------------------------------------------------------
-- Public invite preview (safe fields only; no auth required)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- resolve_user_role: add delegate routing (not a user_roles row)
-- Priority: admin > verified agent > delegate > agent (unverified) > buyer
-- ---------------------------------------------------------------------------
...
BEGIN
  ...
  -- Delegate-only AAC users (membership is source of truth; no licensed agent profile)
