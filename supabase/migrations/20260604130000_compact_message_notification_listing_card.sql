-- Compact listing snapshot for message notification emails.
-- Joins listing agent profile for brokerage/office attribution.
-- Drops detail-panel fields (description, year_built, garage, lot_size).
