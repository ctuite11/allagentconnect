-- Attach full listing snapshot to listing-scoped message notification emails.
-- Role-aware View listing URL: agent → /property/:id, buyer → /consumer-property/:id
  ...
  LOOP
    ...
    IF r.listing_id IS NOT NULL THEN
      SELECT jsonb_build_object(
        ...
        'property_styles', l.property_styles,
        'description', l.description,
        'year_built', l.year_built,
        'garage_spaces', l.garage_spaces,
        'lot_size', l.lot_size
      )
      INTO v_listing
