        ...
        <tr><td style="background-color:#ffffff;border:1px solid #e5e7eb;border-top:none;padding:48px 56px;">
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
            <tr><td align="center" style="padding:0;">
              <a href="${ctaUrl}" style="display:inline-block;padding:13px 28px;background-color:#111317;color:#ffffff;text-decoration:none;font-size:15px;font-weight:500;border-radius:8px;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;">Create your account &rarr;</a>
            </td></tr>
          </table>
