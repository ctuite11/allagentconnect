    ...
    <tr><td align="center" style="padding:32px 16px 48px;">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;">
        ...
        <tr><td style="background-color:#ffffff;border:1px solid ${BORDER};border-top:none;padding:36px 40px 8px;">
          <p style="margin:0 0 18px;font-size:16px;line-height:1.6;color:${TEXT_DARK};font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;font-weight:700;">Hi, my name is Chris Tuite. I’m a Massachusetts real estate broker with more than 30 years in the business, and I know firsthand the value of a strong network — and having the inside scoop — when it comes to best serving my clients.</p>
          <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:${TEXT_BODY};font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;">Amid the ongoing battles with Zillow and others over who controls the real estate industry, I felt the need to build something different: <strong>All Agent Connect</strong>.</p>
          <p style="margin:26px 0 26px;font-size:15px;line-height:1.65;color:${EMERALD_ACCENT};font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;font-weight:700;text-transform:uppercase;letter-spacing:0.04em;">ONE NETWORK. ALL AGENTS.</p>
          <p style="margin:0 0 24px;font-size:15px;line-height:1.65;color:${TEXT_BODY};font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;">AAC was built around a simple idea: agents are stronger when we’re connected directly to one another — sharing buyer demand, off-market and coming-soon opportunities, market intelligence, and the information that helps us better serve our clients.</p>
