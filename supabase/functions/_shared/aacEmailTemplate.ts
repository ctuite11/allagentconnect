      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;">
        ...
        <tr><td align="center" style="background-color:#111317;border-radius:12px 12px 0 0;padding:32px 40px 0;">
          <table role="presentation" cellspacing="0" cellpadding="0"><tr><td align="center">
            <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="width:44px;height:44px;" arcsize="50%" fill="true" stroke="false"><v:fill color="#1e2330"/><v:textbox inset="0,0,0,0" style="mso-fit-shape-to-text:false;"><center style="font-size:16px;font-weight:700;color:#ffffff;font-family:Arial,sans-serif;">AAC</center></v:textbox></v:roundrect><![endif]-->
            <!--[if !mso]><!-->
            <div style="width:44px;height:44px;border-radius:50%;background-color:rgba(255,255,255,0.08);display:inline-block;text-align:center;line-height:44px;font-size:16px;font-weight:700;color:#ffffff;font-family:Arial,Helvetica,sans-serif;letter-spacing:0.5px;">AAC</div>
            <!--<![endif]-->
          </td></tr></table>
          <p style="margin:10px 0 0;font-size:18px;font-weight:600;letter-spacing:-0.02em;color:#ffffff;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;">All Agent Connect</p>
