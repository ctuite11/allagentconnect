...
Deno.serve(async (req) => {
  ...
  if (!e || !c || !t || !VALID_CATEGORIES.has(c)) {
    return htmlPage("Invalid link", "<h1>Invalid unsubscribe link</h1><p>This link is malformed or expired. Please contact hello@allagentconnect.com.</p>", 400);
  }
  ...
  if (!success) {
    return htmlPage("Error", "<h1>Something went wrong</h1><p>We couldn't process your request. Please email hello@allagentconnect.com.</p>", 500);
  }
